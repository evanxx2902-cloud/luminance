...
su - luminance -c "/usr/local/bin/pg_ctl -D /data/pg-business -l /data/log/pg-business-migrate.log start -w -t 30" || true
su - luminance -c "/usr/local/bin/pg_ctl -D /data/pg-vector -l /data/log/pg-vector-migrate.log start -w -t 30" || true
...
su - luminance -c "/usr/local/bin/pg_ctl -D /data/pg-business stop" || true
su - luminance -c "/usr/local/bin/pg_ctl -D /data/pg-vector stop" || true
